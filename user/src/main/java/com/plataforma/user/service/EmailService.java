...
public class EmailService {
 ...
 //   private final JavaMailSender mailSender;
    ...
    public void sendVerificationEmail(String email, String verificationToken) {
        ...
        String message ="Click the button bellow to verify your emai address:";
    ...
    public void sendForgotPasswordEmail(String email, String resetToken) {
        ...
        String message = "Click the button bellow to reset your password:";
    ...
    private void sendEmail(String email, String token, String subject, String path, String message) {
        ...
        String content = """
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border-radius: 8px; background-color: #f9f9f9; text-align: center;">
                    <h2 style="color: #333;">
                    <h2 style="color: #333;">%s</h2>
                    <p style="font-size: 16px; color: #555;">%s</p>
                    <a href="%s" style="display: inline-block; margin:20px 0; padding: 10px 20px; font-size: 16px; color: #fff: background-color: #3a093aff; text-decoration: none;">%s</a>
                    <p style="font-size: 14px; color: #777;">Ou copie e cole o link abaixo no seu navegador:</p>
                    <p style="font-size: 14px; color: #601263ff;">%s</p>
                    <p style="font-size: 12px; color: #aaa;">Este é um e-mail automático. Por favor, não responda.</p>
                </div>
                """.formatted(subject, message, actionUrl, message, actionUrl);
